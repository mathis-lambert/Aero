...
enum WebStore {
    ...
    static func package(_ identifier: String, session: URLSession = .shared) async throws -> Data {
    ...
    static func newerVersion(of identifier: String, than version: String, session: URLSession = .shared) async throws -> String? {
